    ...
    <div class="feedback-form-container">
      ...
      (ngSubmit)="leaveFeedback(); feedbackForm.reset();">
        ...
        <fieldset>
          ...
          <input type="submit" [disabled]="!feedbackForm.valid"
...
export class FeedbackComponent {
  ...
  // Build a feedback form with 4 controls and include data validation
    ...
    this.preexistingFeedback = [
      {
        ...
        recommend: 'Yes',
        comments: 'Everything was perfect, from the service to the quality of the products.'
      },
      {
        rating: '4',
        likes: ['Price'],
        recommend: 'Yes',
        comments: 'Great prices and good service, will definitely recommend to friends.'
      },
      {
        rating: '3',
        likes: ['Ambience'],
      ...
      },
      {
        ...
        likes: ['Service'],
        recommend: 'No',
        comments: 'The service was slow, and the quality of the food was not up to the mark.'
      },
      {
        rating: '5',
        likes: ['Service', 'Quality', 'Price', 'Ambience'],
        recommend: 'Yes',
        comments: 'Absolutely loved everything! Great value for money and friendly stax.'
      }
    ];
  }

  /**
   * Method that is a used to return the likes array.
   */
  get likesArray() {
  ...
  leaveFeedback() {
    ...
    // Build an object to capture the values from each of the form controls.
    const newFeedback = {
    ...
    // Add the object to the preexistingFeedback array.
